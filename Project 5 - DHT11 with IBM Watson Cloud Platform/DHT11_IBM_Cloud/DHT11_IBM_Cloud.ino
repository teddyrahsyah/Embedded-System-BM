...
#include <PubSubClient.h> // Install this Library first in Library Manager
#include "DHT.h"

const char* ssid = "MELTRADI";
const char* password = "redline212";

#define DHTPIN 15
#define DHTTYPE DHT11
#define ORG "wcb5ah" 
#define DEVICE_TYPE "ESP32" 
#define DEVICE_ID "44441712CFA4" 
#define TOKEN "k-DoexRtb(@6k*iBNu" 
